function makeLineChart(dataset, xName, yObjs, axisLables) {
    ...
    chartObj.margin = {top: 15, right: 100, bottom: 30, left: 110};
...
// Render the chart
    chartObj.render = function () {
        ...
        chartObj.svg.append("g").attr("class", "y axis").call(chartObj.yAxis).append("text").attr("class", "label").attr("transform", "rotate(-90)").attr("y", -42).attr("x", -chartObj.height / 2).attr("dy", ".71em").style("text-anchor", "middle").attr("font-color", "white");
        ...
        for (var y  in yObjs) {
            ...
            yObjs[y].tooltip.append("circle").attr("r", 5).attr("stroke",color(y));
            yObjs[y].tooltip.append("rect").attr("x", 8).attr("y","-5").attr("width",80).attr("height",'0.75em');
            yObjs[y].tooltip.append("text").attr("x", 9).attr("dy", ".35em").attr("font-color","white").attr("fill","#868E96");
        }

        // Year label
        focus.append("text").attr("class", "focus year").attr("x", 9).attr("y", 7).attr("fill","#868E96");
        // Focus line
        ...
        function mousemove() {
            ...
            focus.select(".focus.year").text("Year: " + chartObj.xFormatter(chartObj.xFunct(d))).style("font-color","white");
        }
